...
package protobuf_test_messages.editions.proto3
{
    ...
    public final class TestAllTypesProto3MapStringForeignEnumEntry
    {
         ...
         */
        [Inline]
        public static function reset(msg:TestAllTypesProto3MapStringForeignEnumEntry):void
        {
            msg.key = "";
            msg.value = 0;
         ...
         */
        public static function clone(src:TestAllTypesProto3MapStringForeignEnumEntry):TestAllTypesProto3MapStringForeignEnumEntry
        {
            if (!src)
                return null;

            const dst:TestAllTypesProto3MapStringForeignEnumEntry = new TestAllTypesProto3MapStringForeignEnumEntry();
            dst.key = src.key;
            dst.value = src.value;
         ...
         */
        public static function deserializeBytes(src:ByteArray, dst:TestAllTypesProto3MapStringForeignEnumEntry = null, limit:uint = 0, reset:Boolean = true):TestAllTypesProto3MapStringForeignEnumEntry
        {
            if (!dst)
                dst = new TestAllTypesProto3MapStringForeignEnumEntry();
            else if (reset)
                TestAllTypesProto3MapStringForeignEnumEntry.reset(dst);
         ...
         */
        public static function serializeBytes(src:TestAllTypesProto3MapStringForeignEnumEntry, dst:ByteArray):void
        {
            if (!src)
                return;
