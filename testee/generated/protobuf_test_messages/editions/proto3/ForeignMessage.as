...
package protobuf_test_messages.editions.proto3
{
    ...
    public final class ForeignMessage
    {
         ...
         */
        public static function deserializeBytes(src:ByteArray, dst:protobuf_test_messages.editions.proto3.ForeignMessage, length:uint, reset:Boolean = true):protobuf_test_messages.editions.proto3.ForeignMessage
        {
            if (!dst)
