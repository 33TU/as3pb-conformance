...
package protobuf_test_messages.editions.proto3
{
    ...
    public final class ForeignMessage
    {
        ...
        public static const TYPE_URL:String = "type.googleapis.com/protobuf_test_messages.editions.proto3.ForeignMessage";
         ...
         */
        [Inline]
        public static function reset(msg:protobuf_test_messages.editions.proto3.ForeignMessage):void
        {
            msg.c = 0;
         ...
         */
        public static function clone(src:protobuf_test_messages.editions.proto3.ForeignMessage):protobuf_test_messages.editions.proto3.ForeignMessage
        {
            if (!src)
                return null;

            const dst:protobuf_test_messages.editions.proto3.ForeignMessage = new protobuf_test_messages.editions.proto3.ForeignMessage();
            dst.c = src.c;
         ...
         */
        public static function deserializeBytes(src:ByteArray, dst:protobuf_test_messages.editions.proto3.ForeignMessage = null, limit:uint = 0, reset:Boolean = true):protobuf_test_messages.editions.proto3.ForeignMessage
        {
        ...
        public static function deserializeMemory(src:UnpackContext, dst:protobuf_test_messages.editions.proto3.ForeignMessage = null, limit:uint = 0, reset:Boolean = true):protobuf_test_messages.editions.proto3.ForeignMessage
        {
            if (!dst)
                dst = new protobuf_test_messages.editions.proto3.ForeignMessage();
            else if (reset)
                protobuf_test_messages.editions.proto3.ForeignMessage.reset(dst);
         ...
         */
        public static function serializeBytes(src:protobuf_test_messages.editions.proto3.ForeignMessage, dst:ByteArray):void
        {
            if (!src)
                return;
