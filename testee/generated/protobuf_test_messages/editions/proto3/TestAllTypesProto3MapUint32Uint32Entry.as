...
package protobuf_test_messages.editions.proto3
{
    ...
    public final class TestAllTypesProto3MapUint32Uint32Entry
    {
         ...
         */
        [Inline]
        public static function reset(msg:TestAllTypesProto3MapUint32Uint32Entry):void
        {
            msg.key = 0;
            msg.value = 0;
         ...
         */
        public static function clone(src:TestAllTypesProto3MapUint32Uint32Entry):TestAllTypesProto3MapUint32Uint32Entry
        {
            if (!src)
                return null;
         ...
         */
        public static function deserializeBytes(src:ByteArray, dst:TestAllTypesProto3MapUint32Uint32Entry = null, limit:uint = 0, reset:Boolean = true):TestAllTypesProto3MapUint32Uint32Entry
        {
            if (!dst)
                dst = new TestAllTypesProto3MapUint32Uint32Entry();
            else if (reset)
                TestAllTypesProto3MapUint32Uint32Entry.reset(dst);
         ...
         */
        public static function serializeBytes(src:TestAllTypesProto3MapUint32Uint32Entry, dst:ByteArray):void
        {
            if (!src)
                return;
