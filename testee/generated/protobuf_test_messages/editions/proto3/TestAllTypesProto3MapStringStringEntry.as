...
package protobuf_test_messages.editions.proto3
{
    ...
    public final class TestAllTypesProto3MapStringStringEntry
    {
         ...
         */
        [Inline]
        public static function reset(msg:TestAllTypesProto3MapStringStringEntry):void
        {
            msg.key = "";
            msg.value = "";
         ...
         */
        public static function clone(src:TestAllTypesProto3MapStringStringEntry):TestAllTypesProto3MapStringStringEntry
        {
            if (!src)
                return null;
         ...
         */
        public static function deserializeBytes(src:ByteArray, dst:TestAllTypesProto3MapStringStringEntry = null, limit:uint = 0, reset:Boolean = true):TestAllTypesProto3MapStringStringEntry
        {
            if (!dst)
                dst = new TestAllTypesProto3MapStringStringEntry();
            else if (reset)
                TestAllTypesProto3MapStringStringEntry.reset(dst);
         ...
         */
        public static function serializeBytes(src:TestAllTypesProto3MapStringStringEntry, dst:ByteArray):void
        {
            if (!src)
                return;
