...
package protobuf_test_messages.editions.proto3
{
    ...
    public final class TestAllTypesProto3MapStringStringEntry
    {
        ...
        public static const TYPE_URL:String = "type.googleapis.com/protobuf_test_messages.editions.proto3.TestAllTypesProto3.MapStringStringEntry";
         ...
         */
        [Inline]
        public static function reset(msg:protobuf_test_messages.editions.proto3.TestAllTypesProto3MapStringStringEntry):void
        {
            msg.key = "";
            msg.value = "";
         ...
         */
        public static function clone(src:protobuf_test_messages.editions.proto3.TestAllTypesProto3MapStringStringEntry):protobuf_test_messages.editions.proto3.TestAllTypesProto3MapStringStringEntry
        {
            if (!src)
                return null;

            const dst:protobuf_test_messages.editions.proto3.TestAllTypesProto3MapStringStringEntry = new protobuf_test_messages.editions.proto3.TestAllTypesProto3MapStringStringEntry();
            dst.key = src.key;
            dst.value = src.value;
         ...
         */
        public static function deserializeBytes(src:ByteArray, dst:protobuf_test_messages.editions.proto3.TestAllTypesProto3MapStringStringEntry = null, limit:uint = 0, reset:Boolean = true):protobuf_test_messages.editions.proto3.TestAllTypesProto3MapStringStringEntry
        {
        ...
        public static function deserializeMemory(src:UnpackContext, dst:protobuf_test_messages.editions.proto3.TestAllTypesProto3MapStringStringEntry = null, limit:uint = 0, reset:Boolean = true):protobuf_test_messages.editions.proto3.TestAllTypesProto3MapStringStringEntry
        {
            if (!dst)
                dst = new protobuf_test_messages.editions.proto3.TestAllTypesProto3MapStringStringEntry();
            else if (reset)
                protobuf_test_messages.editions.proto3.TestAllTypesProto3MapStringStringEntry.reset(dst);
         ...
         */
        public static function serializeBytes(src:protobuf_test_messages.editions.proto3.TestAllTypesProto3MapStringStringEntry, dst:ByteArray):void
        {
            if (!src)
                return;
