...
package protobuf_test_messages.editions.proto3
{
    ...
    public final class TestAllTypesProto3MapInt32DoubleEntry
    {
         ...
         */
        [Inline]
        public static function reset(msg:TestAllTypesProto3MapInt32DoubleEntry):void
        {
            msg.key = 0;
            msg.value = 0.0;
         ...
         */
        public static function clone(src:TestAllTypesProto3MapInt32DoubleEntry):TestAllTypesProto3MapInt32DoubleEntry
        {
            if (!src)
                return null;

            const dst:TestAllTypesProto3MapInt32DoubleEntry = new TestAllTypesProto3MapInt32DoubleEntry();
            dst.key = src.key;
            dst.value = src.value;
         ...
         */
        public static function deserializeBytes(src:ByteArray, dst:TestAllTypesProto3MapInt32DoubleEntry = null, limit:uint = 0, reset:Boolean = true):TestAllTypesProto3MapInt32DoubleEntry
        {
            if (!dst)
                dst = new TestAllTypesProto3MapInt32DoubleEntry();
            else if (reset)
                TestAllTypesProto3MapInt32DoubleEntry.reset(dst);
         ...
         */
        public static function serializeBytes(src:TestAllTypesProto3MapInt32DoubleEntry, dst:ByteArray):void
        {
            if (!src)
                return;
