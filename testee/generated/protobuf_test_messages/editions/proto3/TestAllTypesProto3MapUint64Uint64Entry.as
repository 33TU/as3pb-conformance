...
package protobuf_test_messages.editions.proto3
{
    ...
    public final class TestAllTypesProto3MapUint64Uint64Entry
    {
         ...
         */
        [Inline]
        public static function reset(msg:TestAllTypesProto3MapUint64Uint64Entry):void
        {
            msg.key.low = 0;
            msg.key.high = 0;
            msg.value.low = 0;
         ...
         */
        public static function clone(src:TestAllTypesProto3MapUint64Uint64Entry):TestAllTypesProto3MapUint64Uint64Entry
        {
            if (!src)
                return null;
         ...
         */
        public static function deserializeBytes(src:ByteArray, dst:TestAllTypesProto3MapUint64Uint64Entry = null, limit:uint = 0, reset:Boolean = true):TestAllTypesProto3MapUint64Uint64Entry
        {
            if (!dst)
                dst = new TestAllTypesProto3MapUint64Uint64Entry();
            else if (reset)
                TestAllTypesProto3MapUint64Uint64Entry.reset(dst);
         ...
         */
        public static function serializeBytes(src:TestAllTypesProto3MapUint64Uint64Entry, dst:ByteArray):void
        {
            if (!src)
                return;
