...
package protobuf_test_messages.editions.proto3
{
    ...
    public final class EnumOnlyProto3
    {
         ...
         */
        [Inline]
        public static function reset(msg:protobuf_test_messages.editions.proto3.EnumOnlyProto3):void
        {
         ...
         */
        public static function clone(src:protobuf_test_messages.editions.proto3.EnumOnlyProto3):protobuf_test_messages.editions.proto3.EnumOnlyProto3
        {
            if (!src)
                return null;

            const dst:protobuf_test_messages.editions.proto3.EnumOnlyProto3 = new protobuf_test_messages.editions.proto3.EnumOnlyProto3();
         ...
         */
        public static function deserializeBytes(src:ByteArray, dst:protobuf_test_messages.editions.proto3.EnumOnlyProto3 = null, limit:uint = 0, reset:Boolean = true):protobuf_test_messages.editions.proto3.EnumOnlyProto3
        {
        ...
        public static function deserializeMemory(src:UnpackContext, dst:protobuf_test_messages.editions.proto3.EnumOnlyProto3 = null, limit:uint = 0, reset:Boolean = true):protobuf_test_messages.editions.proto3.EnumOnlyProto3
        {
            if (!dst)
                dst = new protobuf_test_messages.editions.proto3.EnumOnlyProto3();
            else if (reset)
                protobuf_test_messages.editions.proto3.EnumOnlyProto3.reset(dst);
         ...
         */
        public static function serializeBytes(src:protobuf_test_messages.editions.proto3.EnumOnlyProto3, dst:ByteArray):void
        {
            if (!src)
                return;
