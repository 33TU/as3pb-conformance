...
package protobuf_test_messages.editions.proto3
{
    ...
    public final class EnumOnlyProto3
    {
         ...
         */
        public static function deserializeBytes(src:ByteArray, dst:protobuf_test_messages.editions.proto3.EnumOnlyProto3, length:uint, reset:Boolean = true):protobuf_test_messages.editions.proto3.EnumOnlyProto3
        {
            if (!dst)
