...
package protobuf_test_messages.editions.proto3
{
    ...
    public final class NullHypothesisProto3
    {
        ...
        public static const TYPE_URL:String = "type.googleapis.com/protobuf_test_messages.editions.proto3.NullHypothesisProto3";
        ...
        public static function deserializeMemory(src:UnpackContext, dst:protobuf_test_messages.editions.proto3.NullHypothesisProto3 = null, limit:uint = 0, reset:Boolean = true):protobuf_test_messages.editions.proto3.NullHypothesisProto3
        {
            if (!dst)
