...
package protobuf_test_messages.editions.proto3
{
    ...
    public final class TestAllTypesProto3MapStringNestedMessageEntry
    {
        ...
        public static function deserializeMemory(src:UnpackContext, dst:protobuf_test_messages.editions.proto3.TestAllTypesProto3MapStringNestedMessageEntry = null, limit:uint = 0, reset:Boolean = true):protobuf_test_messages.editions.proto3.TestAllTypesProto3MapStringNestedMessageEntry
        {
            if (!dst)
                ...
                while (src.position < end)
                {
                    ...
                    switch (tag)
                    {
                        ...
                        case 18:
                        {
                            ...
                            dst.value = protobuf_test_messages.editions.proto3.TestAllTypesProto3NestedMessage.deserializeMemory(src, dst.value, src.position + messageLength, false);
                            break;
                        }
                        default:
                        {
