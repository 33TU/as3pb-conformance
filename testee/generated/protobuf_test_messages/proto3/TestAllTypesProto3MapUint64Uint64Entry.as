...
package protobuf_test_messages.proto3
{
    ...
    public final class TestAllTypesProto3MapUint64Uint64Entry
    {
        ...
        public static const TYPE_URL:String = "type.googleapis.com/protobuf_test_messages.proto3.TestAllTypesProto3.MapUint64Uint64Entry";
         ...
         */
        [Inline]
        public static function reset(msg:protobuf_test_messages.proto3.TestAllTypesProto3MapUint64Uint64Entry):void
        {
            msg.key.low = 0;
            msg.key.high = 0;
            msg.value.low = 0;
         ...
         */
        public static function clone(src:protobuf_test_messages.proto3.TestAllTypesProto3MapUint64Uint64Entry):protobuf_test_messages.proto3.TestAllTypesProto3MapUint64Uint64Entry
        {
            if (!src)
                return null;

            const dst:protobuf_test_messages.proto3.TestAllTypesProto3MapUint64Uint64Entry = new protobuf_test_messages.proto3.TestAllTypesProto3MapUint64Uint64Entry();
         ...
         */
        public static function deserializeBytes(src:ByteArray, dst:protobuf_test_messages.proto3.TestAllTypesProto3MapUint64Uint64Entry = null, limit:uint = 0, reset:Boolean = true):protobuf_test_messages.proto3.TestAllTypesProto3MapUint64Uint64Entry
        {
        ...
        public static function deserializeMemory(src:UnpackContext, dst:protobuf_test_messages.proto3.TestAllTypesProto3MapUint64Uint64Entry = null, limit:uint = 0, reset:Boolean = true):protobuf_test_messages.proto3.TestAllTypesProto3MapUint64Uint64Entry
        {
            if (!dst)
                dst = new protobuf_test_messages.proto3.TestAllTypesProto3MapUint64Uint64Entry();
            else if (reset)
                protobuf_test_messages.proto3.TestAllTypesProto3MapUint64Uint64Entry.reset(dst);
         ...
         */
        public static function serializeBytes(src:protobuf_test_messages.proto3.TestAllTypesProto3MapUint64Uint64Entry, dst:ByteArray):void
        {
            if (!src)
                return;
