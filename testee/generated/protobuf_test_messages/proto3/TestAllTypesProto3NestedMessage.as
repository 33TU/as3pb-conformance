...
package protobuf_test_messages.proto3
{
    ...
    public final class TestAllTypesProto3NestedMessage
    {
         ...
         */
        public static function deserializeBytes(src:ByteArray, dst:protobuf_test_messages.proto3.TestAllTypesProto3NestedMessage, length:uint, reset:Boolean = true):protobuf_test_messages.proto3.TestAllTypesProto3NestedMessage
        {
            if (!dst)
            ...
            while (src.position < end)
            {
                ...
                switch (tag)
                {
                    ...
                    case 18:
                    {
                        dst.corecursive = protobuf_test_messages.proto3.TestAllTypesProto3.deserializeBytes(src, dst.corecursive, Deserialize.readVarint32(src), false);
                        break;
                    }
                    default:
                    {
