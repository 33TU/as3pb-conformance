...
package protobuf_test_messages.proto3
{
    ...
    public final class TestAllTypesProto3MapStringBytesEntry
    {
        private static const UNPACK:UnpackContext = new UnpackContext();
        public static const TYPE_URL:String = "type.googleapis.com/protobuf_test_messages.proto3.TestAllTypesProto3.MapStringBytesEntry";
         ...
         */
        [Inline]
        public static function reset(msg:protobuf_test_messages.proto3.TestAllTypesProto3MapStringBytesEntry):void
        {
            msg.key = "";
            msg.value.length = 0;
         ...
         */
        public static function clone(src:protobuf_test_messages.proto3.TestAllTypesProto3MapStringBytesEntry):protobuf_test_messages.proto3.TestAllTypesProto3MapStringBytesEntry
        {
            if (!src)
                return null;

            const dst:protobuf_test_messages.proto3.TestAllTypesProto3MapStringBytesEntry = new protobuf_test_messages.proto3.TestAllTypesProto3MapStringBytesEntry();
            dst.key = src.key;
         ...
         */
        public static function deserializeBytes(src:ByteArray, dst:protobuf_test_messages.proto3.TestAllTypesProto3MapStringBytesEntry = null, limit:uint = 0, reset:Boolean = true):protobuf_test_messages.proto3.TestAllTypesProto3MapStringBytesEntry
        {
        ...
        public static function deserializeMemory(src:UnpackContext, dst:protobuf_test_messages.proto3.TestAllTypesProto3MapStringBytesEntry = null, limit:uint = 0, reset:Boolean = true):protobuf_test_messages.proto3.TestAllTypesProto3MapStringBytesEntry
        {
            if (!dst)
                dst = new protobuf_test_messages.proto3.TestAllTypesProto3MapStringBytesEntry();
            else if (reset)
                protobuf_test_messages.proto3.TestAllTypesProto3MapStringBytesEntry.reset(dst);
         ...
         */
        public static function serializeBytes(src:protobuf_test_messages.proto3.TestAllTypesProto3MapStringBytesEntry, dst:ByteArray):void
        {
            if (!src)
                return;
