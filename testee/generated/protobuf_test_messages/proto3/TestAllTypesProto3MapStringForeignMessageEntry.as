...
package protobuf_test_messages.proto3
{
    ...
    public final class TestAllTypesProto3MapStringForeignMessageEntry
    {
         ...
         */
        public static function deserializeBytes(src:ByteArray, dst:protobuf_test_messages.proto3.TestAllTypesProto3MapStringForeignMessageEntry, length:uint, reset:Boolean = true):protobuf_test_messages.proto3.TestAllTypesProto3MapStringForeignMessageEntry
        {
            if (!dst)
            ...
            while (src.position < end)
            {
                ...
                switch (tag)
                {
                    ...
                    case 18:
                    {
                        dst.value = protobuf_test_messages.proto3.ForeignMessage.deserializeBytes(src, dst.value, Deserialize.readVarint32(src), false);
                        break;
                    }
                    default:
                    {
