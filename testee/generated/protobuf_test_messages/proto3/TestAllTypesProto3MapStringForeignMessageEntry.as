...
package protobuf_test_messages.proto3
{
    ...
    public final class TestAllTypesProto3MapStringForeignMessageEntry
    {
        ...
        public static function deserializeMemory(src:UnpackContext, dst:protobuf_test_messages.proto3.TestAllTypesProto3MapStringForeignMessageEntry = null, limit:uint = 0, reset:Boolean = true):protobuf_test_messages.proto3.TestAllTypesProto3MapStringForeignMessageEntry
        {
            if (!dst)
                ...
                while (src.position < end)
                {
                    ...
                    switch (tag)
                    {
                        ...
                        case 18:
                        {
                            ...
                            dst.value = protobuf_test_messages.proto3.ForeignMessage.deserializeMemory(src, dst.value, src.position + messageLength, false);
                            break;
                        }
                        default:
                        {
