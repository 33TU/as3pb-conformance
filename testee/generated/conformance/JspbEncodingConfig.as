...
package conformance
{
    ...
    public final class JspbEncodingConfig
    {
         ...
         */
        public static function deserializeBytes(src:ByteArray, dst:conformance.JspbEncodingConfig, length:uint, reset:Boolean = true):conformance.JspbEncodingConfig
        {
            if (!dst)
