...
package conformance
{
    ...
    public final class JspbEncodingConfig
    {
        ...
        public static function deserializeMemory(src:UnpackContext, dst:conformance.JspbEncodingConfig = null, limit:uint = 0, reset:Boolean = true):conformance.JspbEncodingConfig
        {
            if (!dst)
            ...
            try
            {
                while (src.position < end)
                {
                    ...
                    switch (tag)
                    {
                        case 8:
                        {
                            dst.useJspbArrayAnyFormat = Unpack.readBool(src);
                            break;
                        }
                        default:
                        {
