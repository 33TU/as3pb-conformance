...
package conformance
{
    ...
    public final class ConformanceResponse
    {
         ...
         */
        public static function deserializeBytes(src:ByteArray, dst:conformance.ConformanceResponse, length:uint, reset:Boolean = true):conformance.ConformanceResponse
        {
            if (!dst)
